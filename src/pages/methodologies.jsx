  ...
  return (
    <div className="min-h-screen bg-white py-4">
      ...
      <div className="max-w-[95vw] lg:max-w-[80vw] mx-auto text-center py-8 bg-white">
        ...
        {/* remove */}
        <p>!!! images should be svg fromat</p>
      ...
      <div className="py-12 mt-12 lg:mt-16">
        ...
        <div className="relative mb-4 h-20 lg:h-24 flex justify-center items-center">
          <img
            src={kobaxidze}
            alt="Kobaxidze"
            className="absolute w-12 h-12 lg:w-16 lg:h-16  border-white left-[-40px]"
          />
          <img
            src={ocneba}
            alt="Ocneba"
          ...
          <img
            src={avatar}
            alt="Avatar"
            className="absolute w-12 h-12 lg:w-16 lg:h-16 border-white right-[-40px]"
          />
        </div>
